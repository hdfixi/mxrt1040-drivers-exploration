...
- pin_list:
  - {pin_num: L12, peripheral: LPUART2, signal: RX, pin_signal: GPIO_AD_B1_03, identifier: ''}
  - {pin_num: K11, peripheral: LPUART2, signal: TX, pin_signal: GPIO_AD_B1_02, identifier: ''}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
- pin_list:
  - {pin_num: J12, peripheral: GPIO1, signal: 'gpio_io, 12', pin_signal: GPIO_AD_B0_12}
  - {pin_num: J11, peripheral: GPIO1, signal: 'gpio_io, 13', pin_signal: GPIO_AD_B0_13}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
